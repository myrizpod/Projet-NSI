...
class MenuEngine:
    ...
    def __init__(self,app):
        ...
        self.cases_shop=[["The Duck",0,True,"flip"],["Donald",100,False,"double_jump"],["Pika pika",3,False,"dash"],["Golden Duck",100,False,"double_coin/flip"],["Maskass",100,False,"dash/double_jump"],["Songoku",100,False,"dash/flip"],["Ninja turtle",100,False,"double_jump/flip"],["Black skis",0,True,"no effect"],["Blue skis",100,False,"score boost X1.1"],["Electric skis",100,False,"score boost X1.2"],["Yellow skis",100,False,"score boost X1.3"],["Red skis",100,False,"score boost X1.4"],["Snowy skis",100,False,"score boost X1.5"],["Green skis",100,False,"score boost X1.6"],["Black scarf",0,True,"no effect"],["Blue scarf",100,False,"no effect"],["Electric scarf",100,False,"no effect"],["Yellow_scarf",100,False,"no effect"],["Red scarf",100,False,"no effect"],["Green_and_white_scarf",100,False,"no effect"],["Green scarf",100,False,"no effect"],["Shield",0,False,"shield 1 obstacle"],["Coin +5",100,False,"coin value of 5"],["no bomb",100,False,"removes bombs"],["Froggy",100,False,"Froggy"],["Magnet",100,False,"attracts coins"],["Coins X2",100,False,"value of coins X2"],["Trophy",100,False,"For the best"]]##List of list with info on every shop cases (arg 0: name(str), arg 1: price(int), arg 2: boolean(true if unlocked, false otherwise), arg 3(if available): str(object'effect))
