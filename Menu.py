...
class MenuEngine:
    ...
    def __init__(self,app):
        ...
        self.cases_shop=[["The Duck",0,True,"flip"],["Donald",100,False,"double_jump"],["Pika pika",150,False,"dash"],["Golden Duck",300,False,"double_coin/flip"],["Maskass",400,False,"dash/double_jump"],["Songoku",300,False,"dash/flip"],["Ninja turtle",200,False,"double_jump/flip"],["Black skis",0,True,"score boost X1"],["Blue skis",100,False,"score boost X1.1"],["Electric skis",200,False,"score boost X1.2"],["Yellow skis",300,False,"score boost X1.3"],["Red skis",400,False,"score boost X1.4"],["Snowy skis",500,False,"score boost X1.5"],["Green skis",600,False,"score boost X1.6"],["Black scarf",0,True,"no effect"],["Blue scarf",100,False,"no effect"],["Electric scarf",100,False,"no effect"],["Yellow_scarf",100,False,"no effect"],["Red scarf",100,False,"no effect"],["Green_and_white_scarf",100,False,"no effect"],["Green scarf",100,False,"no effect"],["Shield",300,False,"shield 1 obstacle"],["Coin +5",200,False,"coin value of 5"],["no bomb",500,False,"removes bombs"],["Froggy",150,False,"jumps higher"],["Magnet",250,False,"attracts coins"],["Coins X2",700,False,"value of coins X2"],["Trophy",1000,False,"For the best"]]##List of list with info on every shop cases (arg 0: name(str), arg 1: price(int), arg 2: boolean(true if unlocked, false otherwise), arg 3(if available): str(object'effect))
    ...
    def settings_interface(self):
        ...
        if self.screensize[0]-97 <= pyxel.mouse_x <= self.screensize[0]-92 and self.screensize[1]-43 <= pyxel.mouse_y <= self.screensize[1]-38:
            ...
            if pyxel.btnp(pyxel.MOUSE_BUTTON_LEFT) and self.music_volume<7:
                self.music_volume+=1
                music.play_music(self.music_volume)
        else:
